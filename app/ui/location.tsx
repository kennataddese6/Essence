...
export default function Location() {
  return (
    <div className="flex flex-wrap-reverse my-5 mx-4">
      ...
      <div className="w-full lg:w-1/2 rounded-3xl">
        ...
        <div className="my-4 ml-auto mr-auto w-28 h-0.5 bg-black lg:ml-24 lg:mr-0 bg-gradient-to-r from-green-400 to-blue-500"></div>
        <p className="lg:ml-24 lg:text-start">
          {" "}
